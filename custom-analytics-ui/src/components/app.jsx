        ...
        <div className="main-content">
          ...
          <div className="app-charts">
            <Card zDepth={3} style={styles.app.chartCard}>
              <CardTitle title="Reactions" className="subheader" style={styles.app.cardTitle}
                         titleStyle={styles.app.cardTitleSize} titleColor={colors.deepBlue}/>
              <CardMedia>
            ...
            <Card zDepth={3} style={styles.app.chartCard} >
              <CardTitle title="Therapy" className="subheader" style={styles.app.cardTitle}
                         titleStyle={styles.app.cardTitleSize} titleColor={colors.deepBlue}/>
              <CardMedia>
                <div className="chart-wrapper">
            ...
            <Card zDepth={3} style={styles.app.chartCard}>
              <CardTitle title="Risk" className="subheader" style={styles.app.cardTitle}
                         titleStyle={styles.app.cardTitleSize} titleColor={colors.deepBlue}/>
              <CardMedia>
                <div className="chart-wrapper">
